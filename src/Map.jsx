...
export default function Map() {
    ...
    useEffect(() => {
        ...
        function loadShopScene() {
            ...
            const calcProgress = () => {
                if (shopTotal > 0) {
                    targetProgress = (shopLoaded / shopTotal) * 90; 
                }
            };
        ...
        function loadWorldScene() {
            ...
            if (currentShopScene) {
                ...
                // Disposal des objets pour libérer la RAM
                currentShopScene.traverse((child) => {
        ...
        // Nettoyage complet lors du démontage pour éviter les fuites de mémoire (OOM)
        return () => {
            ...
            // Disposal des ressources Three.js
